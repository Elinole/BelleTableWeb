	...
	<div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="navigation-index">
	    	...
	    	<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<a href="http://belletable.epizy.com/ConcoursBT/forum">
				...
				<?php
						...
						{
							echo "<li>
					<a rel='tooltip' title='Se déconnecter' data-placement='bottom' href='deconnexion.php' class='btn btn-white btn-simple btn-just-icon'>
